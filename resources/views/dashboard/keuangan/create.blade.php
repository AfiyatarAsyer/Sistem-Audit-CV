...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        {{-- FORM POST --}}
        <div class="col-lg-10">
                <form method="post" action="/dashboard/keuangan" class="mb-5" enctype="multipart/form-data">
                    @csrf

                    
                    <div class="mb-3">
                    <label for="name" class="form-label">Nama Keuangan</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('pemasukan') is-invalid @enderror" id="pemasukan" name="pemasukan" required>
                    @error('pemasukan')
                    <div class="invalid-feedback">
                            {{ $message }}
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('pengeluaran') is-invalid @enderror" id="pengeluaran" name="pengeluaran" required>
                    @error('pengeluaran')
                    <div class="invalid-feedback">
                            {{ $message }}
                    </div>
